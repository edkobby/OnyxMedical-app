...
export default function AdminDoctorsPage() {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const avatarPath = formData.get('avatar') as string;
    ...
    const doctorData = {
        ...
        avatar: avatarPath || '/images/doctors/placeholder.jpg',
    };
          ...
          <Card key={doctor.id}>
            <CardHeader className="flex-row gap-4 items-center">
               <Image
                  ...
                  height={80}
                  src={doctor.avatar || '/images/doctors/placeholder.jpg'}
                  ...
                  width={80}
                  onError={(e) => { e.currentTarget.src = '/images/doctors/placeholder.jpg'; }}
                />
              <div>
              ...
              <form onSubmit={handleFormSubmit} className="max-h-[75vh] overflow-y-auto pr-6 grid gap-4 py-4">
                  ...
                  <div className="space-y-2">
                   ...
                   <div className="space-y-2">
                      ...
                      <Input id="avatar" name="avatar" type="text" defaultValue={selectedDoctor?.avatar} placeholder="/images/doctors/example.jpg" />
                      <p className="text-xs text-muted-foreground">Manually enter the path to the image in `/public`.</p>
                  </div>
