...
export default function AdminBlogPage() {
  ...
  const formatDateSafe = (dateString: string | Timestamp): string => {
              ...
              <form onSubmit={handleFormSubmit} className="max-h-[75vh] overflow-y-auto pr-6 grid gap-4 py-4">
                  ...
                  <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        name="date" 
                        type="date" 
                        defaultValue={selectedPost?.date ? new Date(selectedPost.date).toISOString().split('T')[0] : new Date().toISOString().split('T')[0]}
                        required 
                      />
                  </div>
                   <div className="space-y-2">
